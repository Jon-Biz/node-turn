...
var server = function(config) {
  ...
  this.callback = config.onCandidateCallback || () => console.error('no candidate callback defined')
  ...
  this.on('binding', function(msg, reply) {
    ...
    console.log('binding', msg.transport.src)
    this.onCandidateCallback(msg.transport.src)
